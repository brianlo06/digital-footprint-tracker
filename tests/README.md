...
- `security/`: encryption, key-rewrap policy, auth fail-closed behavior, PII-safe logging, trusted network parsing, verification-gateway isolation, and the closed provider boundary.
